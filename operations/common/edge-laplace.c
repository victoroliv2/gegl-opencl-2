...
"    min2 = fmin(x3,x4);                                               \n"
"                                                                      \n"
"    *max_result = fmax(x5, fmax(max1, max2));                         \n"
"    *min_result = fmin(x5, fmin(min1, min2));                         \n"
"}                                                                     \n"
"                                                                      \n"
...
"    float4 temp = in[gid1d - 1 - src_width];                          \n"
"    float pix_fl[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d - src_width];                                     \n"
"    float pix_fm[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d + 1 - src_width];                                 \n"
"    float pix_fr[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d - 1];											   \n"
"    float pix_ml[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d];												   \n"
"    float pix_mm[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d + 1];											   \n"
"    float pix_mr[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d - 1 + src_width];                                 \n"
"    float pix_bl[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d + src_width];                                     \n"
"    float pix_bm[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"    temp = in[gid1d + 1 + src_width];                                 \n"
"    float pix_br[4] = { temp.x, temp.y, temp.z, temp.w };			   \n"
"                                                                      \n"
"    int c;                                                            \n"
"    float minval, maxval;                                             \n"
"    float gradient[4];                                                \n"
