...
/* RGBA u8 -> Y float */
"__kernel void rgbau8_to_yf ( __global const uchar4 * in,                                 \n"
"                             __global       float * out)                                 \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v  = convert_float4(in[gid]) / 255.0f;                                       \n"
...
/* Y float -> RGBA u8 */
"__kernel void yf_to_rgbau8 ( __global const float * in,                                  \n"
"                             __global       uchar4 * out)                                \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float  in_v  = in[gid];                                                                \n"
"  float4 out_v = (float4) (in_v, in_v, in_v, 1.0f);                                      \n"
"                                                                                         \n"
"  out[gid] = convert_uchar4_sat_rte(255.0f * out_v);                                     \n"
"}                                                                                        \n"
...
"__kernel void rgbu8_to_ragabaf (__global const uchar  * in,                              \n"
"                              __global       float4 * out)                               \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  uchar3 in_v;                                                                           \n"
...
/* RaGaBaA float -> RGB u8 */
"__kernel void ragabaf_to_rgbu8 (__global const float4 * in,                              \n"
"                              __global       uchar  * out)                               \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v  = in[gid];                                                                \n"
"  float4 tmp   = (in_v.w > BABL_ALPHA_THRESHOLD)? in_v / in_v.w : (float4)(0.0f);        \n"
"  tmp.w        = in_v.w;                                                                 \n"
"  uchar3 out_v = convert_uchar3_sat_rte(255.0f * tmp.w * tmp.xyz);                       \n"
"  vstore3 (out_v, gid, out);                                                             \n"
"}                                                                                        \n"

/* RGB u8 -> R'G'B'A float */
"__kernel void rgbu8_to_rgba_gamma_f (__global const uchar  * in,                         \n"
"                              __global       float4 * out)                               \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  uchar3 in_v;                                                                           \n"
"  float4 out_v;                                                                          \n"
"  in_v = vload3 (gid, in);                                                               \n"
"  float3 tmp = convert_float3(in_v) / 255.0f;                                            \n"
"  out_v = (float4)(linear_to_gamma_2_2(tmp.x),                                           \n"
"                   linear_to_gamma_2_2(tmp.y),                                           \n"
"                   linear_to_gamma_2_2(tmp.z),                                           \n"
"                   1.0f);                                                                \n"
"  out[gid]  = out_v;                                                                     \n"
"}                                                                                        \n"

/* R'G'B'A float -> RGB u8 */
"__kernel void rgba_gamma_f_to_rgbu8 (__global const float4 * in,                         \n"
"                              __global       uchar  * out)                               \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v  = in[gid];                                                                \n"
"  float4 tmp;                                                                            \n"
"  tmp   = (float4)(gamma_2_2_to_linear(in_v.x),                                          \n"
"                   gamma_2_2_to_linear(in_v.y),                                          \n"
"                   gamma_2_2_to_linear(in_v.z),                                          \n"
"                   in_v.w);                                                              \n"
"  uchar3 out_v = convert_uchar3_sat_rte(255.0f * tmp.w * tmp.xyz);                       \n"
...
/* RGB u8 -> Y'CbCrA float */
"__kernel void rgbu8_to_ycbcraf (__global const uchar  * in,                              \n"
"                              __global       float4 * out)                               \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  uchar3 in_v;                                                                           \n"
...
"  in_v = vload3 (gid, in);                                                               \n"
"  float4 tmp;                                                                            \n"
"  tmp.xyz = convert_float3(in_v) / 255.0f;                                               \n"
"  tmp.w   = 1.0f;                                                                        \n"
"  float4 rgb = (float4)(linear_to_gamma_2_2(tmp.x),                                      \n"
"                        linear_to_gamma_2_2(tmp.y),                                      \n"
"                        linear_to_gamma_2_2(tmp.z),                                      \n"
"                        0.0f);                                                           \n"
"                                                                                         \n"
...
/* Y'CbCrA float -> RGB u8 */
"__kernel void ycbcraf_to_rgbu8 (__global const float4 * in,                         \n"
"                              __global       uchar  * out)                               \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v  = in[gid];                                                                \n"
...
"                        0.0f);                                                           \n"
"                                                                                         \n"
"  tmp   = (float4)(gamma_2_2_to_linear(rgb.x),                                           \n"
"                   gamma_2_2_to_linear(rgb.y),                                           \n"
"                   gamma_2_2_to_linear(rgb.z),                                           \n"
"                   in_v.w);                                                              \n"
"  uchar3 out_v = convert_uchar3_sat_rte(255.0f * tmp.w * tmp.xyz);                       \n"
...
/* RGB u8 -> YA float */
"__kernel void rgbu8_to_yaf  (__global const uchar  * in,                                 \n"
"                             __global       float2 * out)                                \n"
"{                                                                                        \n"
...
"  float2 out_v;                                                                          \n"
"                                                                                         \n"
"  float luminance = tmp.x * RGB_LUMINANCE_RED +                                          \n"
"                    tmp.y * RGB_LUMINANCE_GREEN +                                        \n"
"                    tmp.z * RGB_LUMINANCE_BLUE;                                          \n"
"                                                                                         \n"
"  out_v.x = luminance;                                                                   \n"
"  out_v.y = 1.0f;                                                                        \n"
"                                                                                         \n"
...
/* YA float -> RGB u8 */
"__kernel void yaf_to_rgbu8 ( __global const float2 * in,                                 \n"
"                             __global       uchar  * out)                                \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float2 in_v  = in[gid];                                                                \n"
"  float3 tmp = (float3) (in_v.x, in_v.x, in_v.x);                                        \n"
"  uchar3 out_v = convert_uchar3_sat_rte(255.0f * in_v.y * tmp);						  \n"
"  vstore3 (out_v, gid, out);															  \n"
"}                                                                                        \n"
...
/* RGB u8 -> Y float */
"__kernel void rgbu8_to_yf  ( __global const uchar * in,                                  \n"
"                             __global       float * out)                                 \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  uchar3 in_v;                                                                           \n"
...
/* Y float -> RGB u8 */
"__kernel void yf_to_rgbu8  ( __global const float * in,                                  \n"
"                             __global       uchar * out)                                 \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float  in_v  = in[gid];                                                                \n"
"  float3 tmp = (float3) (in_v, in_v, in_v);											  \n"
"  uchar3 out_v = convert_uchar3_sat_rte(255.0f * tmp);									  \n"
"  vstore3 (out_v, gid, out);															  \n"
"}                                                                                        \n";         
